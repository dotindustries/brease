...
require (
	buf.build/gen/go/dot/brease/grpc-ecosystem/gateway/v2 v2.20.0-20231009040727-da70494a324d.1 // indirect
	buf.build/gen/go/dot/brease/grpc/go v1.4.0-20231009040727-da70494a324d.2 // indirect
