...
require (
	buf.build/gen/go/dot/brease/connectrpc/go v1.11.1-20230911193928-296453170e28.1 // indirect
	buf.build/gen/go/dot/brease/protocolbuffers/go v1.31.0-20230911193928-296453170e28.1 // indirect
