...
import { Client, Interceptor, createClient } from "@connectrpc/connect";
...
import { EvaluateRequestSchema } from "@buf/dot_brease.bufbuild_es/brease/context/v1/models_pb.js";
...
export type BreaseClient = {
   ...
   */
  client: Client<typeof ContextService>;
...
export const newClient = (opts: ClientOptions): BreaseClient => {
  ...
  const client = createClient(ContextService, transport);
